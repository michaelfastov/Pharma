    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DoctorRatingId = table.Column<int>(nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClosesAt = table.Column<TimeSpan>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "DoctorToDoctorRatings",
                columns: table => new
                {
                    DoctorToDoctorRatingId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DoctorId = table.Column<int>(nullable: false),
                    DoctorRatingId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoctorToDoctorRatings", x => x.DoctorToDoctorRatingId);
                    table.ForeignKey(
                        name: "FK_DoctorToDoctorRatings_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "DoctorId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DoctorToDoctorRatings_DoctorRatings_DoctorRatingId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reviews_Receptions_ReceptionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorToDoctorRatings_DoctorId",
                table: "DoctorToDoctorRatings",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_DoctorToDoctorRatings_DoctorRatingId",
                table: "DoctorToDoctorRatings",
